...
14. **No elegant variation (synonym cycling).** AI has a built-in repetition penalty that makes it rotate through synonyms instead of reusing a word naturally. A person's name becomes "the head coach," then "the HYROX veteran," then "the Copenhagen ambassador." Real humans just say the name again. If you mean Idan, write Idan. Don't cycle descriptors to avoid repetition.
